...
const ChallengeCard = ({ challenge }) => {
    ...
    return (
        <div className="bg-white text-blue-900 p-6 rounded-lg shadow-md flex flex-col text-center justify-center items-center">
            <img src={challenge.image.url} alt={challenge.title} className="h-40 w-full rounded-lg mb-4" />
            <div
